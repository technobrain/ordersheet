...
class CompanyMastersControllerTest < ActionController::TestCase
  ...
  test "should create company_master" do
    assert_difference('CompanyMaster.count') do
      post :create, company_master: { charge_person: @company_master.charge_person, company_name: @company_master.company_name, contact: @company_master.contact, division_name: @company_master.division_name, tel_no: @company_master.tel_no }
    end
  ...
  test "should update company_master" do
    patch :update, id: @company_master, company_master: { charge_person: @company_master.charge_person, company_name: @company_master.company_name, contact: @company_master.contact, division_name: @company_master.division_name, tel_no: @company_master.tel_no }
    assert_redirected_to company_master_path(assigns(:company_master))
  end
