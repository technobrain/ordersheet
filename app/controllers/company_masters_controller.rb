class CompanyMastersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @company_master.save
        ...
        format.json { render 'show', status: :created, location: @company_master }
      else
  ...
  private
    ...
    def company_master_params
      params.require(:company_master).permit(:company_name, :division_name, :charge_person, :contact, :tel_no)
    end
end
